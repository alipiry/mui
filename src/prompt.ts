import {codeConfig, colors, locations, robotsPlain, teamsPlain, wirelessProfiles} from "./values";
import inquirer from "inquirer";
import fs from "fs";

const questions: Array<object> = [
  { type: 'list', name: 'team', message: 'Choose your team', choices: teamsPlain, default: 'MRL-SPL (26)' },
  { type: 'checkbox', name: 'robots', message: 'Choose your robots', choices: robotsPlain },
  ...
  { type: 'list', name: 'wireless', message: 'Choose your wireless profile', choices: wirelessProfiles, default: 'Lab.wpa' },
